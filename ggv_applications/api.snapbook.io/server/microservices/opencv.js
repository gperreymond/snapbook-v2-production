...
exports.run = function(callback) {
  ...
  seneca.add({role: 'opencv', cmd: 'analyse'}, function (msg, respond) {
  ...
  seneca.add({role: 'opencv', cmd: 'compare'}, function (msg, respond) {
  ...
  seneca.add({role: 'opencv', cmd: 'compute'}, function (msg, respond) {
